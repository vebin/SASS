    ...
    <div class="flex-wrap col-flex">
        <div class="scroll-wrap">
            <div class="ms-g-box">
                ...
                <div v-if="DATA.mark !== ''" class="ms-g-item flex-wrap row-flex">
            ...
            <dl v-if="DATA.followup.length > 0" class="m-gj-box">
                ...
                <dd v-for="(ems, index) in DATA.followup"
                    ...
                    <div class="m-gj-txt">{{ems.remark}}</div>
...
.m-gj-box{width: 100%; box-sizing:border-box;height: auto;
    dt{padding: 0 0.3rem; height: 0.7rem; line-height: 0.7rem;font-size: 0.26rem; color: #333; font-weight: 500;}
    dd{background-color: #fff; padding: 0.1rem 0.3rem 0; height: 1.1rem; }
    .m-gj-txt{font-size: 0.28rem;color: #333; line-height: 0.5rem; height: 0.5rem; overflow: hidden;text-overflow:ellipsis; white-space:nowrap;}
    .m-gj-time{font-size: 0.24rem;color: #666; line-height: 0.36rem; height: 0.5rem;border-bottom:0.02rem solid #eee; text-align:right;}
}
</style>
